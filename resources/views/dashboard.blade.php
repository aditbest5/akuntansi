                            ...
                            <div class="flex-auto p-4 pt-0 -mt-1">
                                <div
                                    ...
                                    <div class="col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-3">
                                        <img src="template/dist/assets/images/widgets/wallet.png" alt=""
                                            class="w-full h-auto">
                                    </div>
                                    <div
                            ...
                            <div class="flex-auto p-4">
                                <div class="grid grid-cols-12 gap-4">
                                    <div class="col-span-12 sm:col-span-4">
                                        <img src="template/dist/assets/images/widgets/user.png" alt=""
                                            class="h-auto w-full">
                                    </div><!--end col-->
                                            ...
                                            <tbody>
                                                ...
                                                <tr
                                                    ...
                                                    <td
                                                        ...
                                                        <img src="template/dist/assets/images/products/01.png"
                                                            alt="" class="me-2 h-10 inline-block">Robotech
                                                        Camera EDM
                                                        5D(White)
                                                    </td>
                                                    <td
                                                ...
                                                <tr
                                                    ...
                                                    <td
                                                        class="p-3 text-base font-medium whitespace-nowrap dark:text-white">
                                                        <img src="template/dist/assets/images/products/03.png"
                                                            alt="" class="me-2 h-10 inline-block">Robotech VR
                                                        5D (Black)
                                                    </td>
                                                    <td
                                                        class="p-3 text-base text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                ...
                                                <tr
                                                    ...
                                                    <td
                                                        class="p-3 text-base font-medium whitespace-nowrap dark:text-white">
                                                        <img src="template/dist/assets/images/products/02.png"
                                                            alt="" class="me-2 h-10 inline-block">Robotech
                                                        Shoes Max-Zon
                                                    </td>
                                                    <td
                                                ...
                                                <tr
                                                    ...
                                                    <td
                                                        class="p-3 text-base font-medium whitespace-nowrap dark:text-white">
                                                        <img src="template/dist/assets/images/products/04.png"
                                                            alt="" class="me-2 h-10 inline-block">Robotech
                                                        Mask N99 [ISI]
                                                    </td>
                                                    <td
