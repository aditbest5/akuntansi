    ...
    <div class="page-wrapper relative ltr:ml-auto rtl:mr-auto rtl:ml-0 w-[calc(100%-50px)] px-4 pt-[64px] duration-300">
                    ...
                    <div class="w-full">
                        <div class="flex flex-wrap justify-between">
                            <div class="items-center ">
                                <h1 class="font-medium text-3xl block dark:text-slate-100">Supplier Type Management
                                </h1>
                                <ol class="list-reset flex text-sm">
                                    ...
                                    <li><span class="text-gray-500 dark:text-slate-400 mx-2">/</span></li>
                                    <li class="text-primary-500 hover:text-primary-600 dark:text-primary-400">Supplier
                                        Type Management
                                    </li>
                                </ol>
                            </div><!--end /div-->
        ...
        <div class="xl:w-full min-h-[calc(100vh-152px)] relative pb-14">
            <div class="flex flex-row justify-start gap-5">
                ...
                <div class="flex flex-row justify-start mb-10"><button onclick="printPreview('Supplier Type Management')"
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($list_supplier_type as $key => $value)
                                                <tr
                                                    ...
                                                    <td
                                                        class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                        {{ $value->supplier_type_status == 0 ? 'Tidak Aktif' : 'Aktif' }}
                                                    </td>
