                            ...
                            <div class="sm:-mx-6 lg:-mx-8">
                                <div class="relative overflow-x-auto block w-full sm:px-6 lg:px-8">
                                    <table class="w-full border-collapse" id="datatable_1">
                                        <thead class="bg-slate-100 dark:bg-slate-700/20">
                                            <tr>
                                                <th scope="col"
                                                    ...
                                                    Document Numbering Format Code
                                                </th>
                                                <th scope="col"
                                                    class="p-3 text-xs font-medium tracking-wider text-left text-gray-700 dark:text-gray-400 uppercase">
                                                    Document Numbering Format Name
                                                </th>
                                                <th scope="col"
                                                    class="p-3 text-xs font-medium tracking-wider text-left text-gray-700 dark:text-gray-400 uppercase">
                                                    Modul Form
                                        ...
                                        <tbody>
                                            @forelse ($list_document_format as $key => $value)
                                                <tr
                                                    ...
                                                    <td class="p-3 text-sm font-medium whitespace-nowrap dark:text-white">
                                                        <img src="template/dist/assets/images/users/avatar-1.png"
                                                            alt=""
                                                            class="mr-2 h-8 rounded-full inline-block" />{{ $value->doc_num_code }}
                                                    </td>
                                                    <td
